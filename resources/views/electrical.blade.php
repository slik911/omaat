        ...
        <div class="container">
            <div class="col-md-12">
                <h5 class="text-white text-center" style="padding-top:70px; text-transform:uppercase">
                    Electrical Installation, IT Solutions and Maintenance Services
                </h5>
            <p class="text-center text-white"><a href="{{route('index')}}" style="text-decoration:none; color:#26D376">Home</a> >>  Electrical Installation, IT Solutions and Maintenance Services </p>
            </div>
        </div>
    </div>
    ...
    <div id="service_content" class="mt-5 mb-5">
        <div class="container">
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6 pt-5 pb-5  pr-3 pl-3" style="background-color:#26D376">

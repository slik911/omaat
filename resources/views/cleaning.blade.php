        ...
        <div class="container">
            <div class="col-md-12">
                <h5 class="text-white text-center" style="padding-top:70px;">
                    PROFEESIONAL CLEANING SERVICES
                </h5>
            <p class="text-center text-white"><a href="{{route('index')}}" style="text-decoration:none; color:#26D376">Home</a> >> Professional Cleaning Services </p>
            </div>
        </div>
    </div>
